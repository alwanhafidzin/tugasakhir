...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 17 Jun 2021 pada 06.55
...
--
-- Struktur dari tabel `materi_share`
--
...
--
-- Struktur dari tabel `nilai_lain`
--
...
--
-- Dumping data untuk tabel `nilai_lain`
--
...
--
-- Struktur dari tabel `persentase_nilai`
--
...
(1, '127.0.0.1', 'administrator', '$2y$10$4iCItprhwu5rzEfUa1yTFek8ipt7bKIEkS4cemNFIcc./ivVYhS/a', 'alwanhafidzin@gmail.com', NULL, '', NULL, NULL, NULL, '0702bc00eda90720423f45d494514d9ae341e606', '$2y$10$KpHuMjFA4w3rzq1SbX7E0u28G9V5uYTeNFvhyO.T5qYLVacbkQYCe', 1268889823, 1623814986, 1, 'Alwan'),
...
(8, '::1', '3509176412630001', '$2y$10$4iCItprhwu5rzEfUa1yTFek8ipt7bKIEkS4cemNFIcc./ivVYhS/a', 'alwanhafidzin@student.ub.ac.id', NULL, NULL, NULL, NULL, NULL, '0c8603fd00ef77d985a103d69d8223b02399acf2', '$2y$10$ZNjJM05OP/dByncroxIa/O.anQXWU3nGFjM8LyZSWC9DH.yDIW4KK', 1623486840, 1623892561, 1, 'Guru Smansasoo.spd'),
...
--
-- Indeks untuk tabel `materi_share`
--
...
--
-- Indeks untuk tabel `persentase_nilai`
--
...
--
-- AUTO_INCREMENT untuk tabel `materi_share`
--
ALTER TABLE `materi_share`
...
--
-- AUTO_INCREMENT untuk tabel `nilai_lain`
--
ALTER TABLE `nilai_lain`
...
--
-- AUTO_INCREMENT untuk tabel `persentase_nilai`
--
ALTER TABLE `persentase_nilai`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Ketidakleluasaan untuk tabel `materi_share`
--
ALTER TABLE `materi_share`
...
--
ALTER TABLE `nilai_siswa`
  ADD CONSTRAINT `nilai_siswa_ibfk_1` FOREIGN KEY (`nis`) REFERENCES `siswa` (`nis`),
  ADD CONSTRAINT `nilai_siswa_ibfk_2` FOREIGN KEY (`nip`) REFERENCES `guru` (`nip`);
