...
class TugasShare extends CI_Controller {
	...
	public function index()
	{
		...
		$tahun_akademik_share = $this->TugasModel->get_tahun_akademik_share($nip);
		...
		$this->load->view('guru/tugas_share/view.php',$data);
		$this->load->view('templates/dashboard/footer.php');
		$this->load->view('guru/tugas_share/script.php');
	}
	public function get_all()
	{
		...
		$data['tugas_share'] = $this->TugasModel->get_all_share_guru($id_t_akademik,$semester,$kode_mapel,$kode_kelas,$nip);
		$this->load->view('guru/tugas_share/data_tugas',$data);
	}
	public function detail($encrypt)
	{
		...
		$data['tugas'] = $this->TugasModel->get_detail_share_by_id($id);
        $this->load->view('templates/dashboard/header.php');
        $this->load->view('templates/dashboard/navbar.php',$data);
        $this->load->view('templates/dashboard/sidebar.php');
		$this->load->view('guru/tugas_share/detail_tugas.php',$data);
		$this->load->view('templates/dashboard/footer.php');
		$this->load->view('guru/tugas_share/script_detail.php',$data);
	}
	public function crud($mode)
	{
		if ($mode == 'delete') {
			if ($this->input->is_ajax_request()) {
				...
				$result = $this->TugasModel->delete_share($id);
				echo json_encode($result);
			}
		}
	}	
	public function get_nilai($encrypt)
	{
		function url_base64_decode($str = '')
		{
			return base64_decode(strtr($str, '.-~', '+=/'));
		...
		$id= url_base64_decode($encrypt);
		$nilai = $this->TugasModel->get_nilai($id);
		$data['nilai'] = $nilai;
		$this->load->view('guru/tugas_share/data_nilai',$data);
	}
}