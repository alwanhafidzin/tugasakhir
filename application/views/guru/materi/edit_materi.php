...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit Materi Guru SMAN 1 SOOKO</h1>
          </div>
          <div class="col-sm-6">
            ...
            <div class="card card-primary card-outline">
             ...
             <?php endforeach;?>
			  ...
			  <div class="input-group mgin mb-3 mgin2">
                  <!-- /btn-group -->
				  <input type="text" autocomplete="off"class="form-control" name="jam"id="jam"value="Belum Disimpan" placeholder="Jam Terakhir Kali Disimpan " disabled="disabled">
              </div>
			  <label class="mgin" for="nama_kelas">Judul Materi</label>
			  <div class="input-group mgin mb-3 mgin2">
                  <!-- /btn-group -->
				  <input type="text" autocomplete="off"class="form-control" name="judul"id="judul"value="<?php echo $judul?>" placeholder="Masukkan Judul Materi yang dibuat ">
