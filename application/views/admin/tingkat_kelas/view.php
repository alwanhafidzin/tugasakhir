          ...
          <div class="modal-content">
            ...
            <div class="col-lg-12">
                <div class="form-group">
                    ...
                    <input type="text" autocomplete="off"class="form-control" name="kode_tingkat" maxlength="8" placeholder="Masukkan Kode Tingkat Kelas" required>
                </div>
                <div class="form-group">
                    <label for="tingkatan">Nama Tingkat Kelas</label>
                    <input type="text" autocomplete="off"class="form-control" name="tingkatan" placeholder="Masukkan Nama Tingkat Kelas" required>
                </div>
            </div>
