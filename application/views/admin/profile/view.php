          ...
          <div class="col-md-3">
            ...
            ?>
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  ...
                  <li class="list-group-item">
                    <b>Gender:</b> <p class="float-right"><?php echo $j_kelamin ?></p>
                  </li>
                </ul>
                   ...
                   <h3>Ganti Email/Password</h3></br>
                    <form  id="quickForm" class="form-horizontal">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="email" class="form-control" id="inputEmail" value="<?php echo $email ?>" placeholder="Email" disabled="disabled" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputName2" class="col-sm-2 col-form-label">Password Lama</label>
                        <div class="col-sm-10">
                          <input type="password" class="form-control" id="password-lama" placeholder="Password Lama" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputExperience" class="col-sm-2 col-form-label">Password Baru</label>
                        <div class="col-sm-10">
                        <input type="password" data-minlength="8" class="form-control" id="password-baru" placeholder="Password Baru" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputSkills" class="col-sm-2 col-form-label">Pass Confirm</label>
                        <div class="col-sm-10">
                          <input type="password" data-minlength="8" class="form-control" id="password-confirm" placeholder="Konfirmasi Password" required>
                        </div>
                      </div>
                      <div class="form-group row">
