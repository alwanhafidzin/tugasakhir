                    ...
                    <?php foreach($buat_akun->result() as $result) : ?>
                     <tr>
                       ...
                       <td class="text-center">
                         <i class="btn btn-xs btn-primary buat_akun" data-tipe="<?php echo $result->tipe ?>"data-id="<?php echo $result->identity ?>" data-placement="top" title="Buat Akun">Buat Akun</i>
                       </td>
                     </tr>
                    <?php endforeach;?>
                  </tbody>
