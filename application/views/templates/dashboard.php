    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        foreach ($main_menu as $main) {
            ...
            $submenu  = $this->db->get_where('menu', array('is_main_menu' => $main->id));

            if ($submenu->num_rows()>0) {
              //submenu true
              echo "<li class='nav-item'>".anchor($main->link,"<i class='".$main->icon."'></i>".
              ...
              // echo "<li class='nav-item'>" .anchor($main->link,"<i class='nav-icon far ".$main->icon."'></i>"."<p>".$main->nama_menu."</p>"). "</li>";
              echo "<li class='nav-item'>".anchor($main->link,
              "<a href='$main->link' class='nav-link'>".
              "<i class='nav-icon far ".$main->icon."'></i>".
              "<p>"
              .$main->nama_menu.
              "</p>".
              "</li>");
              ...
              <div class="card-body">
                ...
                <div class="direct-chat-messages">
                  ...
                  <div class="direct-chat-msg">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="<?=base_url()?>assets/admin_lte/dist/img/user1-128x128.jpg" alt="message user image">
                    <!-- /.direct-chat-img -->
                  ...
                  <div class="direct-chat-msg right">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="<?=base_url()?>assets/admin_lte/dist/img/user3-128x128.jpg" alt="message user image">
                    <!-- /.direct-chat-img -->
                    <div class="direct-chat-text">
                ...
                <div class="direct-chat-contacts">
                  <ul class="contacts-list">
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="<?=base_url()?>assets/admin_lte/dist/img/user1-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="<?=base_url()?>assets/admin_lte/dist/img/user3-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="<?=base_url()?>assets/admin_lte/dist/img/user6-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="<?=base_url()?>assets/admin_lte/dist/img/user8-128x128.jpg" alt="User Avatar">
